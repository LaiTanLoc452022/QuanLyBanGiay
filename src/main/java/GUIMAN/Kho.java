...
public class Kho extends javax.swing.JFrame {
    ...
    public boolean checkIdphanloai(int check){
        for(Phanloai x : listpl){
            if(x.getIdphanLoai() == check){
                return true;
            }
        }
        return false;
    ...
    public void GetDataK(){
        ...
        for (int i = 0; i < sp.size(); ++i) {
            ...
            if(checkIdphanloai(sp.get(i).getPhanloai().getIdphanLoai())){
                rowData[9] = listpl.get(sp.get(i).getPhanloai().getIdphanLoai()-1).getLoai();
                rowData[10] = listpl.get(sp.get(i).getPhanloai().getIdphanLoai()-1).getMota();
            }
            else{
                rowData[9] = "";
                rowData[10] = "";
    ...
    private void initComponents() {
        ...
        jLabel27.setMaximumSize(new java.awt.Dimension(1244, 50));
        jLabel27.setMinimumSize(new java.awt.Dimension(1244, 50));
        jLabel27.setPreferredSize(new java.awt.Dimension(1244, 50));
        ...
        jPanel24Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel31, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
                .addContainerGap())
        );
